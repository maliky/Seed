    ...
    if isinstance(acrosticOrNbWords, str):
        for initial in list(acrosticOrNbWords):
            ...
            try:
                ...
                print("Check that the accrostich is concordante avec la case.")
...
def run():
    ...
    parser.add_argument("--delimIntra", "-i", default=".", help=delimIntra_help)
    parser.add_argument("--delimExtra", "-e", default="_3_", help=delimExtra_help)
    parser.add_argument("--minlen", "-n", type=int, help=minlen_help)
    parser.add_argument("--maxlen", "-x", type=int, default=7, help=maxlen_help)
    parser.add_argument("--case", "-c", default="camel", help=case_help)
    parser.add_argument(
